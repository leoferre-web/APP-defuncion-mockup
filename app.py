...
# CATÁLOGO COMPLETO DE 50 CÓDIGOS CIE-10
CIE10_DB = {
...
with col_t:
    st.markdown("<h1 style='margin-bottom: 0;'>Ministerio de Salud</h1>", unsafe_allow_html=True)
    st.markdown("<h3 style='margin-top: 0; color: #007bff;'>Gobierno de la Provincia de Córdoba</h3>", unsafe_allow_html=True)
...
if st.button("🔴 CONFIRMAR Y ENVIAR REGISTRO OFICIAL", use_container_width=True):
    if nombre_f and causa_a and firma_digital and email_dest and nom_m:
        with st.spinner("Registrando en la nube..."):
            ...
            try:
                ...
                pdf.seccion("CAUSAS"); pdf.item("26-a", "Causa Directa", causa_a)
